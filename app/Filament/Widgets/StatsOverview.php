...
class StatsOverview extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        $previousTransaction = Transaction::whereStatus('approved')->whereMonth('created_at', Carbon::now()->subMonth()->month)->whereYear('created_at', Carbon::now()->subMonth()->year);
        $transactionPercentage = $this->getPercentage($previousTransaction->count(), $transactions->count());
        $revenuePercentage = $this->getPercentage($previousTransaction->sum('total_price'), $transactions->sum('total_price'));
        return [
